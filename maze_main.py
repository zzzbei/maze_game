...
class Application(tk.Frame):
    ...
    def createWidgets(self, x, y):
        ...
        # 下方的四个功能按钮 Button，通过框架控件Frame开辟一个空间，再往里面打包（.pack）放进去 ，再设置 side='left'
    ...
    def handleKey(self, event):
        ...
        mv = None
        if event.keycode == 104: # Down 8
            mv = 'D'
        elif event.keycode == 100: # Left 4
            mv = 'L'
        elif event.keycode == 102: # Right 6
            mv = 'R'
        elif event.keycode == 98: # Up 2
            mv = 'U'
        elif event.keycode == 88: # KP_Down x
            mv = 'D'
        elif event.keycode == 80: # KP_Up p
            mv = 'U'
        elif event.keycode == 83: # KP_Left s
            mv = 'L'
        elif event.keycode == 85: # KP_Right u
            mv = 'R'
